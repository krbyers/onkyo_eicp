...
/**
 * InputCommand represents a command that takes a custom input from an outside<br>
 * source, such as a user.
 * @author Mac
 */
public abstract class InputCommand implements Command{

    public static final Pattern A_V_SYNC_PATTERN = Pattern.compile("snnn");
